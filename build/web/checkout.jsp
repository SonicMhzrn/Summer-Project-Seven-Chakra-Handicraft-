                ...
                <div class="col-md-4 order-md-2 mb-4">
                    ...
                    <ul class="list-group mb-3">
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                                <h6 class="my-0"><%=c.getProduct_name()%></h6>
                                <small class="text-muted">Brief description</small>
                            </div>
                            <span class="text-muted">Rs.<%=c.getPrice()%></span>
                        </li>
                        <%}
                        %>
                ...
                <div class="col-md-8 order-md-1">
                    ...
                    <form action="order" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="custom-control custom-radio">
                            <input id="debit" name="paymentMethod" type="radio" class="custom-control-input" value="Cash on Delivery" onclick="hideImage();" checked required>
                            <label class="custom-control-label" for="debit">Cash on Delivery</label>
                        </div>
                        <div class="d-block my-3">
                            <div class="custom-control custom-radio">
                                <!--<input id="credit" name="paymentMethod" type="radio" class="custom-control-input" value="khalti" onclick="toggleImageVisibility()"  required>-->
<!--                                <label class="custom-control-label" for="credit"><svg width="60px" height="60px" viewBox="0 0 296 113" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                     Generator: Sketch 52.2 (67145) - http://www.bohemiancoding.com/sketch 
                                    <title>khalti logo-01</title>
                                    <desc>Created with Sketch.</desc>
                                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="khalti-logo-01" transform="translate(2.000000, 0.000000)">
                                    <g id="XMLID_486_" transform="translate(18.000000, 0.000000)" fill="#5D2E8E" fill-rule="nonzero">
                                    <g id="XMLID_487_">
                                    ...
                                    <g id="XMLID_483_" transform="translate(131.000000, 14.000000)" fill="#5D2E8E">
                                    <g id="XMLID_484_">
                                    ...
                                    <g id="XMLID_479_" transform="translate(147.000000, 31.000000)" fill="#5D2E8E">
                                    ...
                                    <g id="XMLID_476_" transform="translate(173.000000, 31.000000)" fill="#5D2E8E">
                                    <g id="XMLID_477_">
                                    ...
                                    <g id="XMLID_470_" transform="translate(205.000000, 40.000000)" fill="#5D2E8E" fill-rule="nonzero">
                                    ...
                                    <g id="XMLID_466_" transform="translate(231.000000, 31.000000)" fill="#5D2E8E">
                                    ...
                                    <g id="XMLID_463_" transform="translate(244.000000, 34.000000)" fill="#5D2E8E">
                                    <g id="XMLID_464_">
                                    ...
                                    <g id="XMLID_460_" transform="translate(265.000000, 31.000000)" fill="#5D2E8E">
                                    <g id="XMLID_461_">
                                    ...
                                    <g id="XMLID_457_" transform="translate(262.000000, 41.000000)" fill="#5D2E8E">
                                    <g id="XMLID_458_">
                                    ...
                                    <g id="XMLID_432_" transform="translate(8.500000, 38.000000) rotate(-6.000000) translate(-8.500000, -38.000000) translate(0.000000, 18.000000)" fill="#F9A61C">
                                    <g id="XMLID_453_-link" transform="translate(0.000000, 1.000000)">
                            ...
                            <div class="custom-control custom-radio">
                                <img src="khalti-qr.jpg" id="khaltiImage" style="display: none;">
                                <p id="message" style="display: none;">Please enter your username and email in the purpose section!!!</p>
                            </div>
                        </div>
                        ...
                        <hr class="mb-4">
                        <input type="submit" class="btn btn-primary btn-lg btn-block" type="submit" value="Order Now">
                        <!--<button id="payment-button" class="btn btn-primary btn-lg btn-block">Pay with Khalti</button>-->

                        <a href=""><button class="btn btn-primary btn-lg btn-block" type="submit">Continue Shopping</button></a>
                    </form>
                </div>
            </div>
            ...
            <script>
                function toggleImageVisibility() {
                    var khaltiImage = document.getElementById("khaltiImage");
                    var khaltiRadio = document.getElementById("credit");
                    var message = document.getElementById("message");
                    khaltiImage.style.display = khaltiRadio.checked ? "block" : "none";
                    message.style.display = khaltiRadio.checked ? "block" : "none";
                }
                function hideImage() {
                    var khaltiImage = document.getElementById("khaltiImage");
                    var khaltiRadio = document.getElementById("credit");
