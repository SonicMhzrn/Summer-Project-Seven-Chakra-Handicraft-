                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul id="navbar" class="navbar-nav text-uppercase justify-content-end align-items-center flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link me-4" href="allBowl.jsp">Bowls</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link me-4" href="allStatue.jsp">Statues</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link me-4" href="allBell.jsp">Tinghsa Bells</a>
                            <li class="nav-item">
