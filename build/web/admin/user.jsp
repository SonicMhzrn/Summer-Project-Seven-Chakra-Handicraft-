            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="user.jsp" class="nav-item nav-link active"><i class="fa fa-users me-2"></i>Users</a>
                        <a href="orders.jsp" class="nav-item nav-link"><i class="fa fa-boxes me-2"></i>Orders</a>
                            ...
                            <table class="table text-start align-middle table-bordered table-hover mb-0" border:1px solid black>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><%=u.getPhone()%></td>
                                        <td>
                                            <a href="../Userdelete?id=<%=u.getId()%>" class="btn btn-small btn-danger">Remove</a>
                                        </td>
                                    </tr>
                                    <%
                                            count++;
