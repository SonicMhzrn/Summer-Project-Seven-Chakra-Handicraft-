                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="allBowl.jsp" class="dropdown-item active">Singing Bowls</a>
                            ...
                            <table class="table text-start align-middle table-bordered table-hover mb-0" border:1px solid black>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><%=b.getP_detail()%></td>
                                        <td><%=b.getPrice()%></td>
                                        <td><img src="<%= request.getContextPath()%>/admin/images/<%= b.getImage()%>" style="width:50px; height:50px;"></td>
                                        <td><%=b.getStatus()%></td>
                                        <td>
                                            <a href="edit_product.jsp?id=<%=b.getP_id()%>" class="btn btn-small btn-primary">Edit</a>
                                            <a href="../deleteProduct?id=<%=b.getP_id()%>" class="btn btn-small btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                    <%
                                            count++;
