            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="orders.jsp" class="nav-item nav-link active"><i class="fa fa-box-open me-2"></i>Orders</a>
                            ...
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><%=o.getStatus()%> </td>
                                        <td>
                                            <a href="edit_order.jsp?id=<%=o.getId()%>" class="btn btn-small btn-primary">Edit</a>
                                            <a class="btn btn-sm btn-primary btn-danger" href="../orderdelete?id=<%=o.getId()%>">Delete</a></td>
                                    </tr>
