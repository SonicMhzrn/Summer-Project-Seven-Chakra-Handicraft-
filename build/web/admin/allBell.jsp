<%-- 
    Document   : allStatue
    Created on : Feb 22, 2024, 4:33:20 PM
    Author     : Dell
--%>
                ...
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-boxes me-2"></i>Categories</a>
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="allBowl.jsp" class="dropdown-item">Singing Bowls</a>
                                <a href="allStatue.jsp" class="dropdown-item active">Statues</a>
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="bg-light text-center rounded p-4">
                        ...
                        <div class="responsive">
                            <h3 class="text-center">Tingsha Bells</h3><br>
                            ...
                            <a href="add_product.jsp " class="btn btn-small btn-primary" >Add Tingsha Bells</a>
                            <table class="table text-start align-middle table-bordered table-hover mb-0" border:1px solid black>
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
                                        <th scope="col">Statue Details</th>
                                ...
                                <tbody>
                                    <%
                                        ...
                                        List<Products> list = dao.getAllBell();
                                      int count = 1;
                                      for (Products s : list) {%>
                                    <tr>
                                        ...
                                        <td><%=s.getP_detail()%></td>
                                        <td><%=s.getPrice()%></td>
                                        <td><img src="<%= request.getContextPath()%>/admin/images/<%= s.getImage()%>" style="width:50px; height:50px;"></td>
                                        <td><%=s.getStatus()%></td>
                                        <td>
                                            <a href="edit_product.jsp?id=<%=s.getP_id()%>" class="btn btn-small btn-primary">Edit</a>
                                            <a href="../deleteProduct?id=<%=s.getP_id()%>" class="btn btn-small btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                    <%
                                            count++;
