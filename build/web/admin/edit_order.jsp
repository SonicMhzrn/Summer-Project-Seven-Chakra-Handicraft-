                        ...
                        <div class="col-sm-12 col-xl-6">
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <%
                                    ...
                                    Order s = dao.getAllOrder(id);
                                %> 
                                <form method="post" action="../edit_order">
                                    <input type="hidden" class="form-control" name="pid" value="<%=s.getId()%>">
                                    <div class="row mb-3">
                                        <label for="" class="col-sm-2 col-form-label">Order Id*</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control"  name="pname" value="<%=s.getOrder_id()%>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control"  name="pname" value="<%=s.getFirst_name()%> <%=s.getLast_name()%>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control"  name="pname" value="<%=s.getEmail()%>" readonly >
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="" class="col-sm-2 col-form-label">Phone Number*</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control"  name="pname" value="<%=s.getPhone()%>" readonly>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="" class="col-sm-2 col-form-label">Address*</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control"  name="pname" value="<%=s.getAddress()%>" readonly>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="" class="col-sm-2 col-form-label">Product Name*</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control"  name="pname" value="<%=s.getProduct_name()%>" readonly>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="" class="col-sm-2 col-form-label">Price*</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="price" value="<%=s.getPrice()%>" readonly>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="" class="col-sm-2 col-form-label">Status*</label>
                                            <div class="col-sm-10">
                                                <select class="form-select" name="status">
                                                    <option value="Pending" <%= (s.getStatus().equals("Pending")) ? "selected" : ""%>>Pending</option>
                                                    <option value="Processing" <%= (s.getStatus().equals("Processing")) ? "selected" : ""%>>Processing</option>
                                                    <option value="Shipped" <%= (s.getStatus().equals("Shipped")) ? "selected" : ""%>>Shipped</option>
                                                    <option value="Delivered" <%= (s.getStatus().equals("Delivered")) ? "selected" : ""%>>Delivered</option>
