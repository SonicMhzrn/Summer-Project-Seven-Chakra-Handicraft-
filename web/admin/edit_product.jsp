                        ...
                        <div class="col-sm-12 col-xl-6">
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <%
                                    ...
                                    Products s = dao.getProductBy(id);
                                %> 
                                <form method="post" action="../edit_product" enctype="multipart/form-data">
                                    <input type="hidden" class="form-control" name="pid" value="<%=s.getP_id()%>">
                                    <div class="row mb-3">
                                        <label for="" class="col-sm-2 col-form-label">Statue Detail*</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control"  name="pname" value="<%=s.getP_detail()%>" >
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="" class="col-sm-2 col-form-label">Price*</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="price" value="<%=s.getPrice()%>">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="" class="col-sm-2 col-form-label">Category*</label>
                                        <div class="col-sm-10">
                                            <select name="category" class="form-select form-select-lg mb-3" aria-label=".form-select-sm example">
                                                <% if ("Bowl".equals(s.getCategory())) {%>
                                                <option value="Bowl" selected>Bowl</option>
                                                <option value="Statue">Statue</option>
                                                <option value="Bell">Bell</option>
                                                <%} else if ("Statue".equals(s.getCategory())) {%>
