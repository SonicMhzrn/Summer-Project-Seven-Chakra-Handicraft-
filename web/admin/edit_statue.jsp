                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-sm-12 col-xl-6">
                            <div class="bg-light rounded h-100 p-4">
                                <h6 class="mb-4">Edit-Statue</h6>
                                <%
                                    int id = Integer.parseInt(request.getParameter("id"));
                                    StatueDAOImpl dao = new StatueDAOImpl(DBConnect.getConn());
                                    Statue s = dao.getStatueBy(id);
                                %> 
                                <form method="post" action="../edit_statue" enctype="multipart/form-data">
                                    <input type="hidden" class="form-control" name="sid" value="<%=s.getStatue_id()%>">
                                    <div class="row mb-3">
                                        <label for="" class="col-sm-2 col-form-label">Statue Detail*</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control"  name="sname" value="<%=s.getStatue_detail()%>" >
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <label for="" class="col-sm-2 col-form-label" name="simg">Upload Photo:</label>
                                        <div class="col-sm-10">

                                            <!--<input class="form-control" type="file" id="formFile" onchange="previewImage(event)">-->
                                            <input type="file" name="bimg" required="required" class="form-control" id="formFile" accept="image/*" onchange="previewImage(event)" value="<%=s.getImage()%>">
                                            <!--                                            <div class="col-md-6">
