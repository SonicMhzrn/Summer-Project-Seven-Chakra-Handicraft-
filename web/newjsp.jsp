...
<html>
    ...
    <c:if test="${not empty addCart}">
        ...
        <script type="text/javascript">
            // Function to show toast only if it hasn't been shown before
            ...
            // Call showToast function with content
            showToast("${addCart}");
        </script>
                ...
                <div class="swiper product-swiper">
                    <div class="swiper-wrapper">
                        ...
                        <%
                            ...
                            List<Bowls> list = dao.getBowls();
                            for (Bowls b : list) {%>
                        <div class="swiper-slide">
                            <div class="product-card position-relative">
                                <div class="image-holder">
                                    <img src="admin/images/bowl/<%=b.getPhoto()%>" alt="product-item" class="img-fluid">
                                </div>
                                <div class="cart-concern position-absolute">
                                    <div class="cart-button d-flex">
                                        ...
                                        <%} else {%>
                                        <a href="cartServlet?bid=<%=b.getBowl_id()%>&&uid=<%=u.getId()%>" class="btn btn-medium btn-black">Add to Cart</a>
                                        <%}
                                        %>
                                    </div>
                                </div>
                                <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                                    <h3 class="card-title text-uppercase">
                                        <a href="view_product.jsp?bid=<%=b.getBowl_id()%>"><%=b.getBowl_detail()%></a>
                                    </h3>
                ...
                <div class="swiper product-swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="product-card position-relative">
                                <div class="image-holder">
                                    <img src="images/statues/s-l1200.jpg" alt="product-item" class="img-fluid">
                                </div>
                                <div class="cart-concern position-absolute">
                                    <div class="cart-button d-flex">
                                ...
                                <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                                    ...
                                    <span class="item-price text-primary">Rs.980</span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="product-card position-relative">
                                ...
                                <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                                    ...
                                    <span class="item-price text-primary">Rs.1100</span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="product-card position-relative">
                                ...
                                <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                                    ...
                                    <span class="item-price text-primary">Rs.780</span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                ...
                <div class="swiper product-watch-swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="product-card position-relative">
                                <div class="image-holder">
                                    <img src="images/bells/tingsha-nepalmusicgallery.jpg" alt="product-item" class="img-fluid">
                                </div>
                                <div class="cart-concern position-absolute">
                                    <div class="cart-button d-flex">
                                        <a href="#" class="btn btn-medium btn-black">Add to Cart<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
                                ...
                                <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                                    ...
                                    <span class="item-price text-primary">Rs.870</span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="product-card position-relative">
                                ...
                                <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                                    ...
                                    <span class="item-price text-primary">Rs.680</span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="product-card position-relative">
                                ...
                                <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                                    ...
                                    <span class="item-price text-primary">Rs. 750</span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="product-card position-relative">
                                ...
                                <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                                    ...
                                    <span class="item-price text-primary">Rs.650</span>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
