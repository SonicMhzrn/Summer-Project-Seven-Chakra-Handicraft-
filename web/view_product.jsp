...
<html lang="en">
    ...
    <body>
        ...
        <%
            ...
            Products p = dao.getProductBy(bid);
                ...
                <div class="row gx-5">
                    <aside class="col-lg-6">
                        <div class="border rounded-4 mb-3 d-flex justify-content-center">
                            <a data-fslightbox="mygalley" class="rounded-4" target="_blank" data-type="image" href="https://bootstrap-ecommerce.com/bootstrap5-ecommerce/images/items/detail1/big.webp">
                                <img style="max-width: 100%; max-height: 500px; margin: auto;" class="rounded-4 fit" src="admin/images/<%=p.getImage()%>" />
                            </a>
                        </div>
                    ...
                    <main class="col-lg-6">
                        <div class="ps-lg-3">
                            ...
                            <div class="mb-3">
                                <span class="h5">Rs. <%=p.getPrice()%></span>
                        ...
                        <%} else {%>
                        <a href="cartServlet?bid=<%=p.getP_id()%>&uid=<%=u.getId()%>&quantity=1" class="btn btn-medium btn-black">Add to Cart</a>
                        <%}
                        %>
                    ...
                    <div class="row d-flex flex-wrap justify-content-between">
                        ...
                        <div class="col-lg-3 col-sm-6 pb-3">
                            <div class="footer-menu contact-item">
                                ...
                                <p>If you need support? Just give us a call. <a href="">+977 9876541230</a>
                                </p>
                            </div>
                        </div>
                    </div>
