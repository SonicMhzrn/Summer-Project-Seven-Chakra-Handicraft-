    ...
    <body class="bproduct" data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
        ...
        <section style="background-color: #eee;">
            <div class="text-center container py-8">
                <h4 class="mt-4 mb-5"><strong>Statues</strong></h4>
                    ...
                    <div class="col-lg-4 col-md-12 mb-4">
                        <div class="card">
                            <div class="bg-image hover-zoom ripple ripple-surface ripple-surface-light"
                                ...
                                <img src="admin/images/<%=s.getImage()%>"
                            ...
                            <div class="card-body">
                                <a href="view_product.jsp?bid=<%=s.getP_id()%>" class="text-reset">
                                    <h5 class="card-title mb-3"><%=s.getP_detail()%></h5>
                                </a>
                                 <%if (u == null) {
                                        %>
                                        <a href="login.jsp" class="btn btn-medium btn-black">Add to Cart</a>
                                            <%} else {%>
                                        <a href="cartServlet?bid=<%=s.getP_id()%>&&uid=<%=u.getId()%>" class="btn btn-medium btn-black">Add to Cart</a>
                                            <%}
                                            %>
                                <h6 class="mb-3">Rs. <%=s.getPrice()%></h6>
                            </div>
                        </div>
                    </div>
                    <%
